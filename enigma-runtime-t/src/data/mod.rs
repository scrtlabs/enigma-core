...
pub mod tests {
    ...
    pub fn test_diff_patch() {
        ...
        let patch = StatePatch{ patch: json_patch::diff(&before, &after), previous_hash: [0u8; 32], contract_id: [1u8; 32], index: 0 };
    ...
    pub fn test_apply_delta() {
        ...
        assert_eq!(contract, ContractState { contract_id: id,  json: json!({ "author" : {"name1" : "John", "name2" : "Lennon"},"tags": [ "first", "second", "third"] }), delta_hash, delta_index: 0, } );
    }
