...
//    #[macro_use]
    ...
    pub fn test_diff_patch() {
        ...
        let patch = StatePatch{ data: json_patch::diff(&before, &after), previous_hash: [0u8; 32] };
        assert_eq!(serde_json::to_string(&patch.data).unwrap(), "[{\"op\":\"replace\",\"path\":\"/author/name2\",\"value\":\"Lennon\"},{\"op\":\"add\",\"path\":\"/tags/2\",\"value\":\"third\"},{\"op\":\"remove\",\"path\":\"/title\"}]");
    }
    ...
    pub fn test_encrypt_patch() {
        ...
        let patch = StatePatch { data: serde_json::from_str(s).unwrap(), previous_hash: [0u8; 32]  };
    ...
    pub fn test_apply_delta() {
        ...
        let patch = StatePatch { data: serde_json::from_str(p).unwrap(), previous_hash: [0u8; 32]  };
        ...
        assert_eq!(contract, ContractState { contract_id: b"Enigma".sha256(),  json: json!({ "author" : {"name1" : "John", "name2" : "Lennon"},"tags": [ "first", "second", "third"] }), delta_hash: [0u8; 32], } );
    }

    pub fn test_generate_delta() {
        let p = "[{\"op\":\"replace\",\"path\":\"/author/name2\",\"value\":\"Lennon\"},{\"op\":\"add\",\"path\":\"/tags/2\",\"value\":\"third\"},{\"op\":\"remove\",\"path\":\"/title\"}]";
        let result = StatePatch { data: serde_json::from_str(p).unwrap(), previous_hash: [0u8; 32]  };
        let id = b"Enigma".sha256();
