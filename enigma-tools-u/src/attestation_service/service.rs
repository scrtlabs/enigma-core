...
impl AttestationService {
    ...
    pub fn build_request(&self, quote: &str) -> QuoteRequest {
        QuoteRequest { jsonrpc: "2.0".to_string(),
                       method: "validate".to_string(),
                       params: Params { quote: quote.to_string() },
                       id: 1, }
    }
...
impl Quote {
    pub fn from_base64(encoded_quote: &str) -> Result<Quote, Error> {
        ...
        Ok(Quote { body: QBody::from_bytes_read(&mut &quote_bytes[..48])?,
...
mod test {
    ...
    fn test_get_response_attestation_service() {
        ...
        let service: AttestationService =
            AttestationService::new(attestation_service::constants::ATTESTATION_SERVICE_URL);
