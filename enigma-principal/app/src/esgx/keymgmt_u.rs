...
use enigma_tools_u::web3_utils::type_wrappers::{encode, BlockHeaderWrapper, ReceiptWrapper, ReceiptHashesWrapper, BlockHeaders};
...
pub mod tests {
    ...
    use enigma_tools_u::web3_utils::type_wrappers::{BlockHeaderWrapper};
